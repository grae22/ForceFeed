    ...
    return {
        ...
        execute: function() {
            SubmitterListComponent = (function () {
                ...
                //---------------------------------------------------------------------------
                SubmitterListComponent.prototype.selectAll = function () {
                    this.Checkboxes.forEach(function (box) { return box.setChecked(true); });
                    this.onChange();
                };
                //---------------------------------------------------------------------------
                SubmitterListComponent.prototype.selectNone = function () {
